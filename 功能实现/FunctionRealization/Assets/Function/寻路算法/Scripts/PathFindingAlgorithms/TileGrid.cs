...
namespace PathFinding
{
    public class TileGrid : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            if (GUI.Button(new Rect(0,0,200,80), "BFS"))
            {
                StopPathCoroutine();
            ...
            if (GUI.Button(new Rect(0,100,200,80), "Dijkstra"))
            {
                StopPathCoroutine();
            ...
            if (GUI.Button(new Rect(0,200,200,80), "AStar"))
            {
                StopPathCoroutine();
            ...
            if (GUI.Button(new Rect(0,300,200,80), "GreedyBestFirstSearch"))
            {
                StopPathCoroutine();
            ...
            if (GUI.Button(new Rect(0,400,200,80),"Reset" ))
            {
                StopPathCoroutine();
                ResetGrid();
