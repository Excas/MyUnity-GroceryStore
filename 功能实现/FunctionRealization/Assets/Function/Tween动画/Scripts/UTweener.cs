...
public class UTweener : AutoRun
{
    ...
    public static UTweener MaxTweener(UTweener[] tweeners)
    {
        UTweener max = null;
    ...
    public static void PlayTween(UTweener[] tweeners, bool resetToBeginning)
    {
        for (int i = 0; i < tweeners.Length; ++i)
        {
    ...
    public static void StopTween(UTweener[] tweeners, bool resetToEnd)
    {
        for (int i = 0; i < tweeners.Length; ++i)
        {
            tweeners[i].Stop();
