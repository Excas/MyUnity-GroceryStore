...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        public static class Utils
        {
            ...
            /// </summary>
            public static Vector2 SwitchToRectTransform(RectTransform mFrom, RectTransform to)
            {
                Vector2 localPoint;
                Vector2 fromPivotDerivedOffset = new Vector2(mFrom.rect.width * 0.5f + mFrom.rect.xMin, mFrom.rect.height * 0.5f + mFrom.rect.yMin);
                Vector2 screenP = RectTransformUtility.WorldToScreenPoint(null, mFrom.position);
